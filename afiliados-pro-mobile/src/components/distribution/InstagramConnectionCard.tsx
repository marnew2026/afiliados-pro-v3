  ...
  const connectInstagram = useCallback(async () => {
    ...
    try {
      ...
      if (!data?.success || !authorizationUrl) {
        throw new Error(
          "O servidor nao retornou a autorizacao do Instagram."
        );
      }
      ...
      if (!supported) {
        throw new Error(
          "Nao foi possivel abrir a autorizacao do Instagram."
        );
      }
