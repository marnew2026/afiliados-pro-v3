...
import foundingCohortRoutes from "./routes/foundingCohortRoutes.js";
import founderFeedbackRoutes from "./routes/founderFeedbackRoutes.js";
console.log("#################################");
...
app.use("/admin/founding-cohort", foundingCohortRoutes);
app.use("/beta/feedback", founderFeedbackRoutes);
app.use("/", tiktokVerificationRoutes);
